    ...
    render() {
        ...
        if (this.empty) {
            const createEmptyNode = () => ((0, vue_1.h)("div", { class: [
                ...
                ], style: this.bodyStyle, ref: "emptyElRef" }, this.dataTableSlots.empty ? (this.dataTableSlots.empty()) : ((0, vue_1.h)(empty_1.NEmpty, { theme: this.mergedTheme.peers.Empty, themeOverrides: this.mergedTheme.peerOverrides.Empty }))));
