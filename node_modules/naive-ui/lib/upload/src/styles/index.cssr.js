...
exports.default = (0, cssr_1.c)([(0, cssr_1.cB)('upload', 'width: 100%;', [(0, cssr_1.cM)('dragger-inside', [(0, cssr_1.cE)('trigger', `
 ...
 border-radius: var(--n-border-radius);
 `, [(0, fade_in_height_expand_cssr_1.default)(), (0, cssr_1.cB)('progress', [(0, fade_in_height_expand_cssr_1.default)({
  foldPadding: true
})]), (0, cssr_1.c)('&:hover', `
 ...
 `, [(0, cssr_1.cB)('button', [(0, cssr_1.c)('&:not(:last-child)', {
  marginRight: '4px'
}), (0, cssr_1.cB)('base-icon', [(0, cssr_1.c)('svg', [(0, icon_switch_cssr_1.default)()])])]), (0, cssr_1.cM)('image-type', `
 position: relative;
 max-width: 80px;
 width: auto;
 `), (0, cssr_1.cM)('image-card-type', `
