...
const barcode_params = {
  ...
  htm = create.payment_client.aio_check_out_barcode(barcode_info = barcode_params, parameters = base_param, invoice = inv_params, client_redirect_url = client_redirect)
console.log(htm)
